...
constexpr int64_t kMaxRootSize = 64LL * 1024;
constexpr int64_t kMaxDirectorTargetsSize = 64LL * 1024;
constexpr int64_t kMaxTimestampSize = 64LL * 1024;
constexpr int64_t kMaxSnapshotSize = 64LL * 1024;
constexpr int64_t kMaxOfflineSnapshotSize = 1LL * 1024 * 1024;
constexpr int64_t kMaxImageTargetsSize = 8LL * 1024 * 1024;
